...
#最终模型使用完整数据集上的最佳特征集进行训练。并存储在instance$result_feature_set中
...
s <- kernelshap(learner,X=dat[,-c(36)],bg_X=dat)#成功
s
library(shapviz)
# 构建可视化对象
shp <- shapviz(s) 
...
#CPBT+IscMesenteric+CPStatus+MFS+D2+Plt+IscCerebral+CABG